...
class RecorderActivity : AppCompatActivity(R.layout.activity_main) {
    ...
    public override fun onCreate(savedInstance: Bundle?) {
        ...
        if (MediaStore.Audio.Media.RECORD_SOUND_ACTION == intent.action) {
            returnAudio = true
            soundList.visibility = View.GONE
    ...
    private fun applyUiStatus(status: UiStatus) {
        ...
        if (UiStatus.READY == status) {
            ...
            elapsedTimeText.visibility = View.GONE
            recordingVisualizer.visibility = View.GONE
            pauseResume.visibility = View.GONE
        } else {
            soundFab.setImageResource(R.drawable.ic_stop)
            elapsedTimeText.visibility = View.VISIBLE
            recordingVisualizer.visibility = View.VISIBLE
