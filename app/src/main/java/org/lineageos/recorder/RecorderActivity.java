...
public class RecorderActivity extends AppCompatActivity implements
    ...
    private void toggleScreenRecorder() {
        ...
        if (Utils.isScreenRecording(this)) {
            ...
            new Handler().postDelayed(() -> {
                ...
                intent.putExtra(OverlayService.EXTRA_HAS_AUDIO, false /* TODO read stored value from dialog */);
                startService(intent);
                onBackPressed();
            }, 500);
        }
    ...
    private void updateLastItemStatus() {
        ...
        mScreenLast.setVisibility(lastScreen == null ? View.GONE : View.VISIBLE);
        mSoundLast.setVisibility(lastSound == null ? View.GONE : View.VISIBLE);
    }
