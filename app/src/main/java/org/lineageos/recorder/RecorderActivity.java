    ...
    private void promptUser() {
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.confirm, (dialog, which) -> {
                    ...
                    confirmLastResultIfExists(true);
                })
                .setNegativeButton(R.string.discard, (dialog, which) -> {
                    LastRecordHelper.deleteRecording(context,
                            LastRecordHelper.getLastItemUri(context), true);
                    cancelResult(true);
                })
                .setNeutralButton(R.string.record_again, (dialog, which) -> {
                    cancelResult(false);
                })
                .show();
    }
